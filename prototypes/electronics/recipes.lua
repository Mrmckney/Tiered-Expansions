...
-- Ingredients for Photon Processor
local photon_processor_ingredients = {
...
local electronics_recipes = {
    ...
    create_electronics_recipe("photon-processor", photon_processor_ingredients, 30)             -- Photon Processor recipe
}
